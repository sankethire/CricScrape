...
for link in links:
	try:	
		try:
			...
			bat_table, bowl_table = bowlsoup.find_all("table", {"class" : "TableLined"})
			# bowl_table = 
			# print((bowl_table))
			...
			# with open ('Scores/Bowlers/' + new_char +  '_bowlers.csv', "a") as bowlFile:
			...
			for new_char in t:
				...
				for tr in trs:
					...
					try:
						...
						# print(bowl_metadata[0] + ">" + bowl_metadata[1] + ">" + bowl_metadata[2] + ">" + bowl_metadata[3] + ">" + bowl_metadata[4] + ">" + bowl_metadata[5] + ">" + bowl_metadata[6] + ">" + bowl_metadata[7] + ">" + bowl_metadata[8] + ">" + bowl_metadata[9] + ">" + bowl_metadata[10] + ">" + bowl_metadata[11] + ">" + bowl_metadata[12])
						blrs.append(bowl_metadata1[0] + ">" + bowl_metadata1[1] + ">" + bowl_metadata1[2] + ">" + bowl_metadata1[3] + ">" + bowl_metadata1[4] + ">" + bowl_metadata1[5] + ">" + bowl_metadata1[6] + ">" + bowl_metadata1[7] + ">" + bowl_metadata1[8] + ">" + bowl_metadata1[9] + ">" + bowl_metadata1[9])
						# print(bowl_metadata[0] + ">" + bowl_metadata[1] + ">" + bowl_metadata[2] + ">" + bowl_metadata[3] + ">" + bowl_metadata[4] + ">" + bowl_metadata[5] + ">" + bowl_metadata[6] + ">" + bowl_metadata[7] + ">" + bowl_metadata[8] + ">" + bowl_metadata[9])
					except:
						pass
